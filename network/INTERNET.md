...
- Концентратор - соединяет хосты в сеть и передает пакеты всем хостам в сети с помощью broadcast канала.  
- Коммутатор - соединяют хосты в сеть и передает пакеты получателю.  
- Маршрутизатор - соединяет сети компьютеров, а не сами компьютеры.  
- Модем – устройство, предназначенное для переработки сигналов интернет-сети и их декодирования. 
...
### Сеть с использованием маршрутизатора
...
Сеть с использованием провайдеров
